...
class TestSnapshotPolicyClient(PyPowerFlexTestCase):
        ...
        self.MOCK_RESPONSES = {
            self.RESPONSE_MODE.Valid: {
                ...
                f'/instances/SnapshotPolicy::{self.fake_policy_id}/action/removeSnapshotPolicy':
                    {},
                f'/instances/SnapshotPolicy::{self.fake_policy_id}/action/assignSnapshotPolicy':
                    {},
                ...
                f'/instances/SnapshotPolicy::{self.fake_policy_id}/action/pauseSnapshotPolicy':
                    {},
                f'/instances/SnapshotPolicy::{self.fake_policy_id}/action/unassignSnapshotPolicy':
                    {},
    ...
    def test_snapshot_policy_get_statistics_not_supported(self):
        """
        Tests the behavior of the get_statistics method.
        """
        ret = self.client.snapshot_policy.get_statistics(
            snapshot_policy_id=self.fake_policy_id,
            fields=["numOfpypowerflexVols"])
        assert ret is None
